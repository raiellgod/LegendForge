export const backgrounds = [
  ...
  },
  {
    ...
    skillKeys: ["forca-bruta", "sobrevivencia"],
  ...
  },
  {
    ...
    skillKeys: ["manuseio-pesado", "historia"],
    ...
    key: "ruin-scavenger",
    description:
      "Você sobreviveu explorando destroços, cidades quebradas, laboratórios soterrados e zonas esquecidas. Sabe diferenciar lixo de algo valioso.",
    skillKeys: ["investigacao", "demolicao"],
  ...
  },
  {
    ...
    key: "technomancer-apprentice",
    description:
      "Você estudou circuitos antigos, baterias instáveis, runas mecânicas e dispositivos que misturam tecnologia e magia.",
    skillKeys: ["arcanismo", "tecnologia"],
  ...
  },
  {
    ...
    key: "road-courier",
    description:
      "Você cruzou estradas perigosas levando cartas, pacotes, mapas ou segredos. Conhece atalhos, postos seguros e gente perigosa.",
    skillKeys: ["percepcao", "pilotagem"],
  ...
  },
  {
    ...
    key: "field-medic",
    description:
      "Você aprendeu a tratar ferimentos em combate, improvisar curativos, estabilizar aliados e lidar com dor sem tempo para cerimônia.",
    skillKeys: ["medicina", "sobrevivencia"],
  ...
  },
  {
    ...
    key: "militia-strategist",
    description:
      "Você organizou defesas locais, patrulhas improvisadas ou grupos armados em regiões onde nenhum exército chegava a tempo.",
    skillKeys: ["tática", "intimidacao"],
    toolNames: ["Um tipo de jogo ou veículos terrestres"],
    languageChoiceCount: 0,
    languageKeys: [],
    startingGold: 15,
  ...
  },
  {
    ...
    key: "cold-forge-artisan",
    description:
      "Você trabalhou com metal reaproveitado, placas antigas, armas quebradas e proteções adaptadas para sobreviver em um mundo sem fábricas confiáveis.",
    skillKeys: ["oficio", "manuseio-pesado"],
