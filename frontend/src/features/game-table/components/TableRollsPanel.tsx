...
type TableRollsPanelProps = {
  ...
  rollAdvantages: number;
  rollDisadvantages: number;
  ...
  onChangeRollAdvantages: (value: number) => void;
  onChangeRollDisadvantages: (value: number) => void;
...
export function TableRollsPanel({
  ...
  onChangeRollAdvantages,
  onChangeRollDisadvantages,
  ...
  return (
    <section>
      ...
      <div className="mt-5 rounded-xl border border-red-400/25 bg-red-950/20 p-3 shadow-[-4px_4px_0_rgba(0,0,0,0.22)]">
        ...
        <button
          ...
          className="mt-3 w-full rounded-lg border border-red-400/45 bg-red-500/10 px-3 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-red-100 transition hover:border-red-300 hover:bg-red-500/20"
        >
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            <label className="block">
              ...
              <input
                ...
                min={0}
                max={20}
                value={rollAdvantages}
                onChange={(event) =>
                  onChangeRollAdvantages(Number(event.target.value))
                }
                className="mt-1.5 h-10 w-full rounded-lg border border-white/15 bg-black/40 px-3 text-xs font-bold text-white outline-none focus:border-forge-gold"
              />
            </label>
            ...
            <label className="block">
              ...
              <input
                ...
                min={0}
                max={20}
                value={rollDisadvantages}
                onChange={(event) =>
                  onChangeRollDisadvantages(Number(event.target.value))
                }
                className="mt-1.5 h-10 w-full rounded-lg border border-white/15 bg-black/40 px-3 text-xs font-bold text-white outline-none focus:border-forge-gold"
              />
            </label>
